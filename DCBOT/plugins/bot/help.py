...
from DCBOT.utils import help_pannel
from DCBOT.utils.database import get_lang
from DCBOT.utils.decorators.language import LanguageStart, languageCB
from DCBOT.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, AM_CHAT
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.edit_message_text(
            _["help_1"].format(AM_CHAT), reply_markup=keyboard
        )
    else:
        try:
            await update.delete()
        ...
        await update.reply_photo(
            photo=START_IMG_URL,
            caption=_["help_1"].format(AM_CHAT),
