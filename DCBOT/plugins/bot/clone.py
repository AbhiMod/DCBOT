...
async def copy(client, message: Message):
    buttons = [
           [
                InlineKeyboardButton("✘ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ", url="t.me/AMBOTYT"),
            ],
            [
                InlineKeyboardButton("✘ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ", url="t.me/AM_YTSUPPORT"),
            ],
            ]
...
async def clone(bot, msg: Message):
    ...
    try:
        ...
        client = Client(":memory:", API_ID, API_HASH, bot_token=phone, plugins={"root": "DCBOT.modules"})
        await client.start()
