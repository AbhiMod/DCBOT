...
from DCBOT.utils import DAXXBin, get_channeplayCB, seconds_to_min
from DCBOT.utils.database import get_cmode, is_active_chat, is_music_playing
from DCBOT.utils.decorators.language import language, languageCB
from DCBOT.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://telegra.ph/file/10732f260cbbd4a65bfce.jpg",
        caption=_["queue_1"],
    )
